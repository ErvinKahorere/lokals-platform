  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        CategoryTile(icon: Icons.report_problem_outlined, label: 'Report Issue', onTap: () => context.go('/report-issue'), color: AppColors.purpleSoftAlt, iconColor: AppColors.primaryPurple),
      ],
    );
  }
}
