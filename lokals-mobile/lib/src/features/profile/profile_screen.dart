      ...
      child: profile.when(
        data: (summary) {
          ...
          final menu = [
            ...
            ('/events', 'Saved Items', 'Saved events and followed updates.', Icons.bookmark_outline_rounded),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        '${summary.user.defaultArea ?? summary.profile['default_area']?.toString() ?? summary.user.location ?? 'Windhoek'}, ${summary.user.defaultTown ?? summary.profile['default_town']?.toString() ?? 'Namibia'}',
                        textAlign: TextAlign.center,
