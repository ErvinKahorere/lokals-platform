...
const variantClasses: Record<CardVariant, string> = {
  default: 'border border-lokals-border bg-lokals-surface shadow-card',
  service: 'border border-emerald-100 bg-lokals-surface shadow-[0_14px_32px_rgba(15,23,42,0.08)]',
  marketplace: 'border border-slate-200 bg-lokals-surface shadow-[0_14px_32px_rgba(15,23,42,0.08)]',
  job: 'border border-indigo-100 bg-lokals-surface shadow-[0_14px_32px_rgba(15,23,42,0.08)]',
