...
const adminNav: DashboardNavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'All Approvals', to: '/admin/role-applications', icon: ClipboardCheck },
      ...
      { label: 'Feed Engine', to: '/dashboard/admin/feed-engine', icon: Megaphone },
      { label: 'AI Assist Logs', to: '/dashboard/admin/ai-logs', icon: ShieldPlus },
