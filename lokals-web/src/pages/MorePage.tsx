import { Bell, Building2, Home, Package, Settings, ShieldAlert } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard className="bg-white">
        ...
        <div className="mt-4">
          <Link to="/services" className="text-sm font-semibold text-lokals-purple">Open Get Help</Link>
        </div>
      </SectionCard>
    </div>
  )
